...
const NAV_LINKS = [
  ...
  { label: 'Rulebook',          href: '#rulebook',          comingSoon: true  },
];
          ...
          <div className="relative container mx-auto px-6 lg:px-12">
            <div className="flex items-center justify-between transition-all duration-300"
              ...
              <motion.a href="#home" className="flex items-center gap-3 group"
                ...
                onClick={(e) => handleNavClick(e as any, '#home', false, 'Home')}
              >
              ...
              <div className="hidden md:flex items-center gap-1">
                {NAV_LINKS.map(({ label, href, comingSoon }, i) => {
                  const id = href.replace('#', '');
                  ...
                  return (
                    <div key={label} className="relative">
                      <motion.a
                        href={href}
                        onClick={(e) => handleNavClick(e, href, comingSoon, label)}
                        className={`nav-link-item${isActive ? ' active' : ''} nav-animate-in px-3 py-2 text-sm font-semibold tracking-wide transition-colors duration-200
