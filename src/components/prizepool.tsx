  ...
  return (
    <div
      ...
      style={{
        ...
        transform: inView
          ? (hovered
            ? 'translate3d(0,-14px,0) scale(1.03)'
            : 'translate3d(0,0,0) scale(1)')
          : 'translate3d(0,60px,0) scale(0.93)',
        transition: `
          opacity 0.6s cubic-bezier(.22,1,.36,1) ${index * 90}ms,
    ...
    >
      {/* Layer 1: STATIC BASE LAYER (Blur & Base Shadows) */}
      <div style={{
        position: 'absolute', inset: 0, borderRadius: 'inherit',
        background: `linear-gradient(155deg, rgba(${rgb},0.08) 0%, rgba(255,255,255,0.02) 60%, rgba(0,0,0,0.1) 100%)`,
        border: `1px solid rgba(${rgb},0.08)`,
        backdropFilter: 'blur(16px)',
        boxShadow: `0 8px 48px rgba(0,0,0,0.55),inset 0 1px 0 rgba(255,255,255,0.05),inset 0 -1px 0 rgba(0,0,0,0.2)`,
        pointerEvents: 'none'
      }} />

      {/* Layer 2: HOVER OVERLAY LAYER (GPU Accelerated Opacity) */}
      <div style={{
        position: 'absolute', inset: 0, borderRadius: 'inherit',
        background: `linear-gradient(155deg, rgba(${rgb},0.16) 0%, rgba(255,255,255,0.02) 60%, rgba(0,0,0,0.1) 100%)`,
        border: `1px solid rgba(${rgb},0.65)`,
        boxShadow: `0 24px 60px rgba(${rgb},0.18),0 0 0 1px rgba(${rgb},0.08),inset 0 1px 0 rgba(255,255,255,0.12),inset 0 -1px 0 rgba(0,0,0,0.25)`,
        opacity: hovered ? 1 : 0,
      ...
      <div style={{
        position: 'relative', zIndex: 1, padding: '26px 22px 24px',
        boxSizing: 'border-box', overflow: 'hidden', borderRadius: 'inherit',
        ...
        {/* Top-right bloom (Converted to Opacity animation) */}
        <div style={{ position:'absolute',top:'-70px',right:'-70px',width:'220px',height:'220px',
          ...
          opacity: hovered ? 1 : 0.42, transition:'opacity 0.6s ease' }} />
        ...
        <div style={{ position: 'relative', zIndex: 2, height: '100%', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display:'flex',alignItems:'flex-end',justifyContent:'center',
            gap:'8px',height:'130px',marginBottom:'18px',position:'relative' }}>
          ...
          {/* Separator */}
          <div style={{ height:'1px',marginBottom:'14px',position:'relative',
